...
onMounted(() => {
  // Initialize consultation data based on route params
  console.log("Consultation ID:", route.params.id);
});
</script>
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-4">
          <div v-if="!isCallActive" class="flex items-center space-x-2">
            ...
            <span class="text-sm text-gray-600">Appointment in 5 minutes</span>
          </div>
      ...
      <div class="flex w-80 flex-col border-r border-gray-200 bg-white">
        <div class="h-full overflow-y-auto">
          ...
          <div class="border-b border-gray-200 p-4">
            <h2 class="text-lg font-semibold text-gray-900">My Information</h2>
          </div>
          ...
          <div class="border-b border-gray-200 p-4">
            <div class="mb-4 flex items-center space-x-3">
              ...
              <div>
                ...
                <p class="text-sm text-gray-600">
                  {{ patientInfo.age }} years old • {{ patientInfo.gender }}
                </p>
              </div>
            </div>
            <div class="space-y-2 text-sm">
              <div class="flex justify-between">
                ...
                <span class="font-medium">{{ patientInfo.mrn }}</span>
              </div>
              <div class="flex justify-between">
                <span class="text-gray-600">Blood Type:</span>
                <span class="font-medium">{{ patientInfo.bloodType }}</span>
              </div>
              <div class="flex justify-between">
                <span class="text-gray-600">Phone:</span>
                <span class="font-medium">{{ patientInfo.phone }}</span>
              </div>
            </div>
          </div>
          ...
          <div class="relative flex-1 bg-gray-900">
            ...
            >
              <div class="text-center">
                ...
                <p class="text-lg font-medium text-white">Dr. Sarah Smith</p>
