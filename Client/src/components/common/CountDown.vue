<template>
  <div class="mb-10">
    <div
      class="flex flex-wrap justify-center gap-1 mb-2 font-bold text-title-md text-brand-500 ark:text-brand-400 xl:text-title-lg"
    >
      <!-- timer days -->
    ...
    <div class="text-base text-center text-gray-500 ark:text-gray-400">
