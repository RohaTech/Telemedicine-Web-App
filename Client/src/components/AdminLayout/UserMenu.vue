...
<template>
  <div class="relative" ref="dropdownRef">
    ...
    <div
      v-if="dropdownOpen"
      class="ark:bg-gray-dark ark:border-gray-800 absolute right-0 mt-[17px] flex w-[260px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg z-99999"
    >
      <div>
        <span
